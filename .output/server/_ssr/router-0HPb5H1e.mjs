...
//#region node_modules/.nitro/vite/services/ssr/assets/router-0HPb5H1e.js
var import_jsx_runtime = require_jsx_runtime();
var styles_default = "/assets/styles-20IEjzNR.css";
...
var $$splitComponentImporter$1 = () => import("./routes-DqKC7J8n.mjs");
...
var Route$3 = createFileRoute("/api/grok")({ server: { handlers: { POST: async ({ request }) => {
	try {
		...
		if (action === "chatStream") {
			const { createGrokChatSseStream } = await import("./api-handlers-CVopEPS8.mjs");
		...
		const { dispatchApi } = await import("./api-handlers-CVopEPS8.mjs");
