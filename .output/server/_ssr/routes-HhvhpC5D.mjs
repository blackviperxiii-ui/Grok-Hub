...
import { f as getMode, h as modeBadge, p as getModesWithCatalog, t as APP_VERSION } from "./version-xnMxJHGr.mjs";
...
import { f as useGrokHub, t as Badge } from "./card-Dgqzm_EC.mjs";
import { A as History, C as MessageSquare, G as Cable, H as Command, K as Brain, N as Hammer, T as Menu, a as Trash2, b as Minus, c as Square, f as Settings, i as Users, k as Image, l as Sparkles, n as X, o as TimerReset, t as Zap, w as MessageSquarePlus, y as Pencil, z as Ellipsis } from "../_libs/lucide-react.mjs";
import { t as RelativeTime } from "./RelativeTime-CDg-rQ4W.mjs";
import { t as UsageMeterChip } from "./UsageMeter-dfHqEUzV.mjs";
import { t as ProfileAvatar } from "./ProfileAvatar-DhCtn6_K.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-HhvhpC5D.js
...
var AgentsView = (0, import_react.lazy)(() => import("./AgentsView-CUVgimsd.mjs").then((m) => ({ default: m.AgentsView })));
var AutomationsView = (0, import_react.lazy)(() => import("./AutomationsView-B-7LoRXy.mjs").then((m) => ({ default: m.AutomationsView })));
var ChatView = (0, import_react.lazy)(() => import("./ChatView-B0gaQe5d.mjs").then((m) => ({ default: m.ChatView })));
var CommandView = (0, import_react.lazy)(() => import("./CommandView-Baq5m5aK.mjs").then((m) => ({ default: m.CommandView })));
var ConnectorsView = (0, import_react.lazy)(() => import("./ConnectorsView-Cj8fIlHQ.mjs").then((m) => ({ default: m.ConnectorsView })));
var DesktopHostView = (0, import_react.lazy)(() => import("./DesktopHostView-DAnHL72y.mjs").then((m) => ({ default: m.DesktopHostView })));
var HistoryView = (0, import_react.lazy)(() => import("./HistoryView-yzSC2EwD.mjs").then((m) => ({ default: m.HistoryView })));
var ImagineView = (0, import_react.lazy)(() => import("./ImagineView-lrIXdlXq.mjs").then((m) => ({ default: m.ImagineView })));
var SettingsView = (0, import_react.lazy)(() => import("./SettingsView-B3OO_qpq.mjs").then((m) => ({ default: m.SettingsView })));
var SkillsView = (0, import_react.lazy)(() => import("./SkillsView-D3kUc4dy.mjs").then((m) => ({ default: m.SkillsView })));
var NAV = [
	{
		id: "chat",
		label: "Agent",
