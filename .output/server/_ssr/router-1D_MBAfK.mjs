...
//#region node_modules/.nitro/vite/services/ssr/assets/router-1D_MBAfK.js
var import_jsx_runtime = require_jsx_runtime();
var styles_default = "/assets/styles-B1vTfJl2.css";
...
var $$splitComponentImporter$1 = () => import("./routes-8H0vprrC.mjs");
...
var Route$3 = createFileRoute("/api/grok")({ server: { handlers: { POST: async ({ request }) => {
	try {
		...
		const { dispatchApi } = await import("./api-handlers-UkkfHXBK.mjs");
