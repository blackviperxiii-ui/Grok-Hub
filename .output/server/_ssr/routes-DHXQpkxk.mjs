...
import { f as getMode, h as modeBadge, p as getModesWithCatalog, t as APP_VERSION } from "./version-BE4o4tL_.mjs";
...
import { s as useGrokHub, t as Badge } from "./card-J2wZc2w_.mjs";
import { B as Cable, E as History, L as Command, O as Hammer, P as Ellipsis, T as Image, V as Brain, _ as Pencil, a as TimerReset, b as MessageSquarePlus, c as Sparkles, d as Settings, i as Trash2, n as X, r as Users, s as Square, t as Zap, v as Minus, x as Menu, y as MessageSquare } from "../_libs/lucide-react.mjs";
import { t as RelativeTime } from "./RelativeTime-CDg-rQ4W.mjs";
import { t as UsageMeterChip } from "./UsageMeter-CY9tl2wp.mjs";
import { t as ProfileAvatar } from "./ProfileAvatar-DhCtn6_K.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-DHXQpkxk.js
...
var AgentsView = (0, import_react.lazy)(() => import("./AgentsView-CGcD0Fdv.mjs").then((m) => ({ default: m.AgentsView })));
var AutomationsView = (0, import_react.lazy)(() => import("./AutomationsView-cv7JvStl.mjs").then((m) => ({ default: m.AutomationsView })));
var ChatView = (0, import_react.lazy)(() => import("./ChatView-CGg55GnE.mjs").then((m) => ({ default: m.ChatView })));
var CommandView = (0, import_react.lazy)(() => import("./CommandView-B5JeOHyO.mjs").then((m) => ({ default: m.CommandView })));
var ConnectorsView = (0, import_react.lazy)(() => import("./ConnectorsView-CHrydYqq.mjs").then((m) => ({ default: m.ConnectorsView })));
var DesktopHostView = (0, import_react.lazy)(() => import("./DesktopHostView-Bp9BhuKS.mjs").then((m) => ({ default: m.DesktopHostView })));
var HistoryView = (0, import_react.lazy)(() => import("./HistoryView-B6sEg8vD.mjs").then((m) => ({ default: m.HistoryView })));
var ImagineView = (0, import_react.lazy)(() => import("./ImagineView-CiX7X4e6.mjs").then((m) => ({ default: m.ImagineView })));
var SettingsView = (0, import_react.lazy)(() => import("./SettingsView-ihQ18SGF.mjs").then((m) => ({ default: m.SettingsView })));
var SkillsView = (0, import_react.lazy)(() => import("./SkillsView-fQqUYqf0.mjs").then((m) => ({ default: m.SkillsView })));
var NAV = [
	{
		id: "chat",
		label: "Agent",
