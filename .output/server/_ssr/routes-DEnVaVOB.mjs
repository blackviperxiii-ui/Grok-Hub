...
import { f as getMode, h as modeBadge, p as getModesWithCatalog, t as APP_VERSION } from "./version-DpPTbU9E.mjs";
...
import { f as useGrokHub, t as Badge } from "./card-Dx8p0izU.mjs";
...
import { t as UsageMeterChip } from "./UsageMeter-CiJyKV3G.mjs";
import { t as ProfileAvatar } from "./ProfileAvatar-DhCtn6_K.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-DEnVaVOB.js
...
var AgentsView = (0, import_react.lazy)(() => import("./AgentsView-CFZbU5El.mjs").then((m) => ({ default: m.AgentsView })));
var AutomationsView = (0, import_react.lazy)(() => import("./AutomationsView-D8Vmf_7P.mjs").then((m) => ({ default: m.AutomationsView })));
var ChatView = (0, import_react.lazy)(() => import("./ChatView-Ddcd3HTx.mjs").then((m) => ({ default: m.ChatView })));
var CommandView = (0, import_react.lazy)(() => import("./CommandView-Bad6oVM7.mjs").then((m) => ({ default: m.CommandView })));
var ConnectorsView = (0, import_react.lazy)(() => import("./ConnectorsView-BJeVEc47.mjs").then((m) => ({ default: m.ConnectorsView })));
var DesktopHostView = (0, import_react.lazy)(() => import("./DesktopHostView-DN1jB9mc.mjs").then((m) => ({ default: m.DesktopHostView })));
var HistoryView = (0, import_react.lazy)(() => import("./HistoryView-x9wnK54c.mjs").then((m) => ({ default: m.HistoryView })));
var ImagineView = (0, import_react.lazy)(() => import("./ImagineView-cfnF8pvk.mjs").then((m) => ({ default: m.ImagineView })));
var SettingsView = (0, import_react.lazy)(() => import("./SettingsView-CDJodxyl.mjs").then((m) => ({ default: m.SettingsView })));
var SkillsView = (0, import_react.lazy)(() => import("./SkillsView-yHTSVrBT.mjs").then((m) => ({ default: m.SkillsView })));
var NAV = [
	{
		id: "chat",
		label: "Agent",
