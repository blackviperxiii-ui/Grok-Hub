...
//#region node_modules/.nitro/vite/services/ssr/assets/router-CRwgeASk.js
var import_jsx_runtime = require_jsx_runtime();
var styles_default = "/assets/styles-CW8g9TtQ.css";
...
var $$splitComponentImporter$1 = () => import("./routes-Cd9pumEK.mjs");
...
var Route$3 = createFileRoute("/api/grok")({ server: { handlers: { POST: async ({ request }) => {
	try {
		...
		if (action === "chatStream") {
			const { createGrokChatSseStream } = await import("./api-handlers-B6YmpO4_.mjs");
		...
		const { dispatchApi } = await import("./api-handlers-B6YmpO4_.mjs");
