...
//#region node_modules/.nitro/vite/services/ssr/assets/router-Bl--3iKa.js
var import_jsx_runtime = require_jsx_runtime();
var styles_default = "/assets/styles-gVYhe1gg.css";
...
var $$splitComponentImporter$1 = () => import("./routes-BwR6kHWz.mjs");
...
var Route$3 = createFileRoute("/api/grok")({ server: { handlers: { POST: async ({ request }) => {
	try {
		...
		const { dispatchApi } = await import("./api-handlers-BlMUt7it.mjs");
