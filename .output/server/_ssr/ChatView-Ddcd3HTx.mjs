...
import { C as usagePercent, f as getMode, n as PLAN_LIMITS, u as formatUnits } from "./version-DpPTbU9E.mjs";
...
import { a as CardHeader, c as applyMemoryToChips, f as useGrokHub, i as CardDescription, n as Card, o as CardTitle, r as CardContent, t as Badge } from "./card-Dx8p0izU.mjs";
import { B as Compass, E as LoaderCircle, N as Gauge, c as Square, d as ShieldAlert, l as Sparkles, p as Send, s as Terminal, w as MessageSquarePlus } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/ChatView-Ddcd3HTx.js
...
function buildQuickChips(input) {
	...
	chips.push(...defaults);
	let ranked = uniqByValue(applyMemoryToChips(chips, input.memory)).filter((c) => c.value.trim().toLowerCase() !== draft).sort((a, b) => b.score - a.score);
	if (draft.length >= 1) {
									...
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
											...
											children: [
												...
												" suggestion",
												chips.length === 1 ? "" : "s",
												quickAssistMemory.totalEvents > 0 ? ` · learns from you (${quickAssistMemory.hits.length} habits)` : " · adapts as you use it"
											]
										})
									]
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
