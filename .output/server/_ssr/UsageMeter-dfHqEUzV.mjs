...
import { C as usagePercent, n as PLAN_LIMITS, u as formatUnits, w as usageTone } from "./version-xnMxJHGr.mjs";
...
import { D as Link2, P as Gauge, m as RefreshCw } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/UsageMeter-dfHqEUzV.js
			...
			!compact && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
						...
						children: [
							"Opens an in-app sign-in window. Complete login until the Grok chat UI appears, then click ",
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "font-medium text-[var(--color-fg)]",
								children: "Use this session"
							}),
							" in the bar at the bottom of that window. Or paste the",
							" ",
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "font-mono",
								children: "sso"
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
								...
								onClick: () => void onLink(),
								disabled: linkBusy,
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link2, { className: "h-3.5 w-3.5" }), linkBusy ? "Waiting for sign-in…" : "Link Grok website"]
							}),
							ssoCookie ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Badge, {
								variant: "success",
								children: "Linked"
							}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Badge, { children: "Not linked" }),
							ssoCookie ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
								size: "sm",
								variant: "secondary",
								onClick: () => {
									setSsoCookie("");
					...
					linkDetail && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: linkDetail.toLowerCase().includes("linked") || linkDetail.toLowerCase().includes("saved") ? "text-[11px] text-[var(--color-success)]" : "text-[11px] text-[var(--color-muted)]",
						children: linkDetail
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
