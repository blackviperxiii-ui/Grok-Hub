...
//#region node_modules/.nitro/vite/services/ssr/assets/router-B7pq3nHw.js
var import_jsx_runtime = require_jsx_runtime();
var styles_default = "/assets/styles-BLcM__Ha.css";
...
var $$splitComponentImporter$1 = () => import("./routes-Cw4jZ7xd.mjs");
...
var Route$3 = createFileRoute("/api/grok")({ server: { handlers: { POST: async ({ request }) => {
	try {
		...
		if (action === "chatStream") {
			const { createGrokChatSseStream } = await import("./api-handlers-C65QrCIL.mjs");
		...
		const { dispatchApi } = await import("./api-handlers-C65QrCIL.mjs");
