...
//#region node_modules/.nitro/vite/services/ssr/assets/router-BYhv4dh4.js
...
var $$splitComponentImporter$1 = () => import("./routes-qWgfu8ms.mjs");
...
var Route$3 = createFileRoute("/api/grok")({ server: { handlers: { POST: async ({ request }) => {
	try {
		...
		if (action === "chatStream") {
			const { createGrokChatSseStream } = await import("./api-handlers-CyD7_5tS.mjs");
		...
		const { dispatchApi } = await import("./api-handlers-CyD7_5tS.mjs");
