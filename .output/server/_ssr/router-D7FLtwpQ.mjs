...
//#region node_modules/.nitro/vite/services/ssr/assets/router-D7FLtwpQ.js
var import_jsx_runtime = require_jsx_runtime();
var styles_default = "/assets/styles-BoA_zk23.css";
...
var $$splitComponentImporter$1 = () => import("./routes-CTSvkp2_.mjs");
...
var Route$3 = createFileRoute("/api/grok")({ server: { handlers: { POST: async ({ request }) => {
	try {
		...
		if (action === "chatStream") {
			const { createGrokChatSseStream } = await import("./api-handlers-tY3PagyY.mjs");
		...
		const { dispatchApi } = await import("./api-handlers-tY3PagyY.mjs");
