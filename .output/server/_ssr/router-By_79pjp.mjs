...
//#region node_modules/.nitro/vite/services/ssr/assets/router-By_79pjp.js
...
var styles_default = "/assets/styles-BnD0qdgS.css";
...
var $$splitComponentImporter$1 = () => import("./routes-HhvhpC5D.mjs");
...
var Route$3 = createFileRoute("/api/grok")({ server: { handlers: { POST: async ({ request }) => {
	try {
		...
		if (action === "chatStream") {
			const { createGrokChatSseStream } = await import("./api-handlers-Cdn5hvB2.mjs");
		...
		const { dispatchApi } = await import("./api-handlers-Cdn5hvB2.mjs");
