...
//#region node_modules/.nitro/vite/services/ssr/assets/router-1gMVyQen.js
var import_jsx_runtime = require_jsx_runtime();
var styles_default = "/assets/styles-DLy-IJHj.css";
...
var $$splitComponentImporter$1 = () => import("./routes-DFRsAIeE.mjs");
...
var Route$3 = createFileRoute("/api/grok")({ server: { handlers: { POST: async ({ request }) => {
	try {
		...
		if (action === "chatStream") {
			const { createGrokChatSseStream } = await import("./api-handlers-UsMyVIWh.mjs");
		...
		const { dispatchApi } = await import("./api-handlers-UsMyVIWh.mjs");
