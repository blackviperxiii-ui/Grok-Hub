import { t as APP_VERSION, v as parseRateLimitHeaders } from "./version-DpPTbU9E.mjs";
import { XAI_BASE, callXaiChat, callXaiChatStream, callXaiImagine, probeXaiBearer } from "./grok-CuRiPbVH.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/api-handlers-Bt8AST8P.js
/**
...
async function dispatchApi(route, action, body) {
	if (route === "grok") {
		...
		if (action === "classifyModels") {
			...
			const { buildClassifyPrompt, parseGrokSlotPlan, pickSlotModel } = await import("./version-DpPTbU9E.mjs").then((n) => n.T).then((n) => n.w);
			let accessToken = body.accessToken ? String(body.accessToken) : void 0;
			const apiKey = body.apiKey ? String(body.apiKey) : void 0;
			if (body.tokens && typeof body.tokens === "object") try {
