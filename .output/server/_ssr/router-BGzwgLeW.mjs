...
//#region node_modules/.nitro/vite/services/ssr/assets/router-BGzwgLeW.js
...
var styles_default = "/assets/styles-CEoNTuDt.css";
...
var $$splitComponentImporter$1 = () => import("./routes-DHXQpkxk.mjs");
...
var Route$3 = createFileRoute("/api/grok")({ server: { handlers: { POST: async ({ request }) => {
	try {
		...
		if (action === "chatStream") {
			const { createGrokChatSseStream } = await import("./api-handlers-BsXXLCf0.mjs");
		...
		const { dispatchApi } = await import("./api-handlers-BsXXLCf0.mjs");
